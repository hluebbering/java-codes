...
<span class="sp14">2.</span> In-order traversal
...
Traversing a binary tree requires creating an iterator that traverses all subtrees. An InOrder traversal visits the nodes in the following order:
